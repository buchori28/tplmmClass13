...
const drawer = require("../../assets/images/about_screen.png");
    ...
    return (
      <Container>
        <Header>
          ...
          <Body style={{flex: 3}}>
              <Title style={styles.header_title}>Store Detail</Title>
            </Body>
            <Right />
        ...
        <Content style={styles.about_content}>
          <Image source={ drawer } style={styles.about_image}/>
